<%-- 
    Document   : carro
    Created on : 04/12/2019, 07:14:30
    Author     : internet
--%>
...
<%
    String carro = (String) session.getAttribute("carro");
%>
...
<!--    
     <%
                                ...
                                <tr>
                                    ...
                                    <td><span class="glyphicon glyphicon-lock"></span></td>
                                        <%} else {%>
                                    <td><a href="ControleCarro?acao=editar_car&id=<%=c.getIdCarro()%>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp;Editar</a></td>
                                    <td><a href="ControleCarro?acao=excluir_car&id=<%=c.getIdCarro()%>"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;Excluir</a></td>
                                    <%}%>
                                </tr>
                                <%
		...
		<div class="row container box">
			<div class="col-md-8 pull-left">
				<div class="header-info  ">
					<div class="contact pull-left">(11) 6666-6666</div>
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-12 pull-right">
				...
				<div class="contact-box">
					...
					<div class="contact-box-phon"><span class="highlight">Telefone:</span> 666-999-888</div>
					<div class="contact-box-email"><span class="highlight">Email:</span> empresa@dominio.com.br</div>
					<div class="clearfix"></div>
				</div>
			...
			<div class="col-md-8 col-xs-12 pull-left">
				<p class="contact-info">Você tem alguma dúvida ou precisa de informações adicionais?<br>
					<span class="address"><span class="highlight">Endereço: </span> Rua hell 666 | Cep: 6666666 / São Paulo / SP </span></p>
