                ...
                <div class="panel-body">
                    <form name="form_mvc" class="form-horizontal" action="ControleCliente" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="inputTelefone" class="col-lg-2 control-label">Endereço</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputTelefone" name="endereco" placeholder="Digite seu endereço" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputTelefone" class="col-lg-2 control-label">Cep</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputTelefone" name="cep" placeholder="Digite seu cep" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputTelefone" class="col-lg-2 control-label">Bairro</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="inputTelefone" name="bairro" placeholder="Digite seu bairro" value="">
                                </div>
                            </div>
                            <div class="form-group">
